...
.custom-modal .modal-body .row .col-md-6 {
    height: 100%; /* Ensure the body, row, and column are all taking up the full height of the modal */
}
/* -------------------------------- */
/* comentarios */
    .fixed-comment-form {
        position: fixed;
    margin-left:-23px;
        bottom: 5px; /* Espaciado desde el fondo */
        width: 25%; /* Ajusta según necesidad */
        background-color: #fff; /* Fondo blanco para destacarlo sobre el contenido del modal */
    }
...
.hashtag {
    ...
    cursor: pointer;
    border-radius: 25px;
    background-color: #AEDFF7; /* Azul suave */
    color: #333; /* Color de texto oscuro para contrastar con el azul suave */
    font-weight: 600;
    text-shadow: 1px 1px 2px rgba(255, 255, 255, 0.3); /* Sombra blanca para el texto para más legibilidad */
    transition: all 0.3s;
...
.hashtag:hover {
    background-color: #8FCCF3; /* Un azul un poco más oscuro al pasar el mouse */
