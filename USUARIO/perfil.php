...
.profile-location i, .profile-contact i {
    margin-right: 5px;
}
...
.contenimg{
  ...
  text-align: center; /* Asegura que el texto esté centrado horizontalmente dentro del contenedor */
  width: 40%;
  height: 410px;
}

.col-lg-4 {
    max-width: 120%; /* Aumentar el valor para hacer la columna más ancha */
    display: flex;
...
.col-lg-8 {
    width: 41%; /* Aumentar el valor para hacer la columna más ancha */
    height: 40%;
    top: 5px;
    margin-left: -25px;
}
...
.profile-image {
    ...
    object-fit:fill; /* Ajusta según tus preferencias */
    object-position: center center; /* Ajusta según tus preferencias */
}
...
.separador {
    border-bottom: 2px solid #1763E4; /* Cambia el grosor y el color según tus preferencias */
    width: 100%;
...
?>
           <form method="POST" action="otro.php" enctype="multipart/form-data">
...
<script>
    ...
    <div class="profile-info">
        ...
        <h4 class="dark-color"><span class="soy">SOY</span> <?php echo $nombreUsuario . ' ' . $apellidoUsuario; ?></h4>
         <div class="corperson">
